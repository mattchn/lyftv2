...
class TestCalliope(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = Car(CapuletEngine(current_mileage,last_service_mileage), NubbinBattery(today, last_service_date))
    ...
    def test_battery_should_not_be_serviced(self):
        ...
        car = Car(SternmanEngine(current_mileage, last_service_mileage), SpindlerBattery(today, last_service_date))
